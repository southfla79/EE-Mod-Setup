...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\TDDz-1.2.9') Then
		FileWrite($g_LogFile, '>TDDz-1.2.9\* .' & @CRLF)
		_Extract_MoveMod('TDDz-1.2.9')
	EndIf
