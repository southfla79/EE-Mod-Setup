...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\BG1NPC-24.4') Then
		FileWrite($g_LogFile, '>BG1NPC-24.4\* .' & @CRLF)
		_Extract_MoveMod('BG1NPC-24.4')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\DrizztSaga-3') Then
		FileWrite($g_LogFile, '>DrizztSaga-3\* .' & @CRLF)
		_Extract_MoveMod('DrizztSaga-3')
	EndIf
