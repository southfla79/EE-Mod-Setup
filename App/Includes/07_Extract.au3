...
; ================         move files from sub-directories to main     ================
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\CandlekeepMemories-master') Then
		FileWrite($g_LogFile, '>CandlekeepMemories-master\* .' & @CRLF)
		_Extract_MoveMod('CandlekeepMemories-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\HollytheElf-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Velvetfoot-master') Then
		FileWrite($g_LogFile, '>Velvetfoot-master\* .' & @CRLF)
		_Extract_MoveMod('Velvetfoot-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\SpeakDead-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\CivilDisobedience-master') Then
		FileWrite($g_LogFile, '>CivilDisobedience-master\* .' & @CRLF)
		_Extract_MoveMod('CivilDisobedience-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\MelyndaMute-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Isra_NPC_BG2-3.1') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Kim_Pirate-master') Then
		FileWrite($g_LogFile, '>Kim_Pirate-master\* .' & @CRLF)
		_Extract_MoveMod('Kim_Pirate-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\HaveIce-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\BG1NPC-24.6') Then
		FileWrite($g_LogFile, '>BG1NPC-24.6\* .' & @CRLF)
		_Extract_MoveMod('BG1NPC-24.6')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\SheenaHD-master') Then
		FileWrite($g_LogFile, '>SheenaHD-master\* .' & @CRLF)
		_Extract_MoveMod('SheenaHD-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\TheSwordofNoober-2.0.0') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\SharteelSoD-1.3') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Indira_NPC-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\ACBre-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\DarkHorizonsTweaks-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\ToA-3.0') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\SoD-to-BG2EE-Item-Upgrade-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\d5_Random_Tweaks-0.3') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Edwin_Romance-2.11') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Imoen4Ever-3') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\LongerRoadEE-1.8') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\YasraenaEET-18') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\BoneHill-31') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\SwordCoastStratagems-32.8') Then
		FileWrite($g_LogFile, '>SwordCoastStratagems-32.8\* .' & @CRLF)
		_Extract_MoveMod('SwordCoastStratagems-32.8')
	EndIf
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\RuadEE-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\XulayeEet-2.2') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Solaufeins_Rescue_NPC-1.6') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\LeUI-BG1EE-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\BG_Quests_And_Encounters-master') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\bg2-wildmage-2.0.0') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\DrizztSaga-3.02') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Yeslick_NPC-4.0') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\MinscFriendship-1.1') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\ValygarFriendship-1.3') Then
		FileWrite($g_LogFile, '>ValygarFriendship-1.3\* .' & @CRLF)
		_Extract_MoveMod('ValygarFriendship-1.3')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\EndlessBG1-2.1') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Adrian_NPC-5.0') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\Helga-BG1-master') Then
		FileWrite($g_LogFile, '>Helga-BG1-master\* .' & @CRLF)
		_Extract_MoveMod('Helga-BG1-master')
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\MazzyFriendship-3.5') Then
	...
	EndIf
	If StringRegExp($g_Flags[14], 'BWP|BWS|BG1EE|BG2EE|PSTEE') And FileExists($g_GameDir&'\mana_sorcerer-0.3') Then
